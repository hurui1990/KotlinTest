...
class LoadNewsModelImlp(internal var onLoadNewsListener: OnLoadNewsListener) : LoadNewsModel {
    ...
    internal var newsBaseUrl = "http://toutiao-ali.juheapi.com"
    internal var weatherBaseUrl = "https://free-api.heweather.com"
    internal var newsCode = "5b52ab9c7ccd4e13b5639ca2e3d1d723"
...
//        val callback = loadNewsService.getNewsResult("APPCODE " + newsCode, type)
//
